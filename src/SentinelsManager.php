...
class SentinelsManager {
     ...
     *
     * @param array $sentinels List of sentinel servers
     * @param string $masterName Name of the master
     * @param string|null $sentinelPassword Password for sentinel authentication
     * @param string|null $sentinelUsername Username for sentinel authentication (Redis 6.0+)
     * @return array [host,port] address of redis master server or throws exception.
     **/
    function discoverMaster ($sentinels, $masterName, $sentinelPassword = null, $sentinelUsername = null) {
        foreach ($sentinels as $sentinel) {
            ...
            $connection->password = $sentinelPassword;
            $connection->username = $sentinelUsername;
